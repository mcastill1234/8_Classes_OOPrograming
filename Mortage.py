def findPayment(loan, r, m):
    """Assumes: loan and r are floats, m an int, returns the monthly payment for a mortgage of
    size loan at a monthly rate r for m months."""
    return loan*((r*(1 + r)**m)/((1 + r)**m - 1))


class Mortgage(object):
    """Abstract class for building different kinds of mortgges"""
    ...
    def getTotalPaid(self):
        """Return the total amount of paid so far"""
